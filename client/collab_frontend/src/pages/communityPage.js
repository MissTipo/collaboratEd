...
import { Accordion, Box, Button, Divider, List, ListItem, ListItemText, Stack, Typography } from '@mui/material'
  ...
  return (
    <Box p={5} >
        <Box sx={{display:'flex', justifyContent:'center', alignItems:'center'}}>
            <Typography><h1 style={{border:'2px solid', padding:'10px', borderRadius:'10px' }}>Welcome To CollaboratEd Community !</h1></Typography>
        </Box>
        ...
        <Stack style={{justifyContent:'center', alignItems:'center'}}>
            ...
            <Typography variant='h5'>Institutions</Typography>
                <Stack sx={{display:'flex', borderBottom:'2px solid', justifyContent:'space-evenly'}} direction='row'>
                    <Accordion>
                        <Accordion.Control sx={{display:'flex', flexDirection:'column'}}>
                        <List>
                        ...
                        <List >
                            <ListItem sx={{display:'flex', flexDirection:'column'}}>
                                <img src={Dimg2} alt="microverse"></img>
                ...
                <Stack sx={{display:'flex', borderBottom:'2px solid', justifyContent:'space-evenly'}} direction='row'>
                    ...
                    <List >
                        <ListItem sx={{display:'flex', flexDirection:'column'}}>
                            <img src={Dimg1} alt="Data Science"></img>
                            <ListItemText primary="Data Science" />
                        </ListItem>
                    </List>
                    <List >
                        <ListItem sx={{display:'flex', flexDirection:'column'}}>
                            <img src={Dimg2} alt="Digital Marketing"></img>
                ...
                <Stack sx={{display:'flex', borderBottom:'2px solid', justifyContent:'space-evenly'}} direction='row'> 
                    <List >
                        <ListItem sx={{display:'flex', flexDirection:'column'}}>
                            <img src={Dimg1} alt="mechanics"></img>
                            <ListItemText primary="The Mechanics" />
